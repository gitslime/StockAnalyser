...
#define FUNC_DECLARATION(METHOD)    \
    extern VOID METHOD##_Statistics(IN ULONG ulIndex, IN FILE_WHOLE_DATA_S *pstBuyEntry);   \
...
ULONG GetMethod(IN CHAR* szMethod)
{
    ...
    else if (0 == _stricmp(szMethod, "oma")) {
        ulMethod = METHOD_OMA;
    }
    else {
